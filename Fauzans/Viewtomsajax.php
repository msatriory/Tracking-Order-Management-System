...
<div class="component">
                <div class="panel panel-danger">
                    ...
                    <button id="button1">Export To Pdf</button>
...
<!--                     <tr>
               ...
               <?php
                    ...
                    foreach($isiska->result() as $data):                      
                        ...
                        echo "<tr><td contenteditable='false' style='text-align:center'><input type='text' name='No<?php echo $i?>' id='No<?php echo $i?>' value='$data->No'>".$data->No."</td>";
                        ...
                        echo "<td style='text-align:center'><input type='text' name='Status<?php echo $i?>' id='Status<?php echo $i; $i=$i+1?>'>".$data->Status."</input></td>";
