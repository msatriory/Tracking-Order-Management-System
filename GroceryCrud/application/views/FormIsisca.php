        ...
        <div id="page-wrapper">
            ...
            <div>
                ...
                <div class="form-group form-horizontal">
                    ...
                    <div class="input-group col-sm-8">
                        <input type="text" class="form-control" id="BW_Packet" name="BW_Packet" placeholder="BW_Packet">
                    </div>
                </div>
                <div class="form-group form-horizontal">
                ...
                <div class="form-group form-horizontal">
                    ...
                    <div class="input-group col-sm-8">
                        <input type="text" class="form-control" id="Sales_by" name="Sales_by" placeholder="Sales_by">
                    </div>
                </div>
                <div class="form-group form-horizontal">
