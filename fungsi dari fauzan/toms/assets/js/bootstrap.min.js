...
if ("undefined" == typeof jQuery) throw new Error(
    ...
    d.VERSION = "3.3.4", d.TRANSITION_DURATION = 150, d.prototype.close =
        function(b) {
            function c() {
    ...
    function b(b) {
        b && 3 === b.which || (a(e).remove(), a(f).each(function() {
            ...
            e.hasClass("open") && (e.trigger(b = a.Event(
                    "hide.bs.dropdown", f)), b.isDefaultPrevented() ||
    ...
    g.VERSION = "3.3.4", g.prototype.toggle = function(d) {
        ...
        if (/(38|40|27|32)/.test(b.which) && !/input|textarea/i.test(b.target
            ...
            if (b.preventDefault(), b.stopPropagation(), !d.is(
                ...
                var e = c(d),
                    g = e.hasClass("open");
                if (!g && 27 != b.which || g && 27 == b.which) return 27 ==
                    b.which && e.find(f).trigger("focus"), d.trigger(
                        "click");
                var h = " li:not(.disabled):visible a",
                    i = e.find('[role="menu"]' + h + ', [role="listbox"]' +
                        h);
                if (i.length) {
                    var j = i.index(b.target);
                    38 == b.which && j > 0 && j--, 40 == b.which && j < i.length -
    ...
    a.fn.dropdown = d, a.fn.dropdown.Constructor = g, a.fn.dropdown.noConflict =
        function() {
            ...
            "keydown.bs.dropdown.data-api", '[role="menu"]', g.prototype.keydown
    ...
    c.VERSION = "3.3.4", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        return c && c.$tip && c.$tip.is(":visible") ? void(c.hoverState =
            "in") : (c || (c = new this.constructor(b.currentTarget,
                this.getDelegateOptions()), a(b.currentTarget).data(
                "bs." + this.type, c)), clearTimeout(c.timeout), c.hoverState =
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (j) {
                var n = h,
                    o = this.options.container ? a(this.options.container) :
                    this.$element.parent(),
                    p = this.getPosition(o);
                h = "bottom" == h && k.bottom + m > p.bottom ? "top" :
                    "top" == h && k.top - m < p.top ? "bottom" : "right" ==
                    h && k.right + l > p.width ? "left" : "left" == h && k.left -
                    l < p.left ? "right" : h, f.removeClass(n).addClass(h)
            }
        ...
        b && (c = a(b.currentTarget).data("bs." + this.type), c || (c = new this
            ...
            a(b.currentTarget).data("bs." + this.type, c))), c.tip().hasClass(
